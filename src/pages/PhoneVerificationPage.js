...
import PhoneCodePage from './PhoneCodePage'


	function PhoneVerificationPage({ navigation }) {
		return (
				...
				<View style={styles.viewofall}>
					<Text style={styles.text}>Qual o número do seu telefone celular?</Text>
				  	...
				  	<TouchableOpacity style={styles.button} onPress={() => {navigation.navigate( 'PhoneCodePage')}}>
